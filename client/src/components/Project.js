...
export default function Project(props) {
    ...
    const emptyCard = (projectId) => {
        if (identity === "owner" || identity === "developer") {
            return (
                <React.Fragment>
                    <Typography >You don't have any container yet. Create one!</Typography>
            ...
            return (
                <React.Fragment>
                    <Typography >There's nothing in the project yet.</Typography>
                </React.Fragment>
            )
        }
    };
